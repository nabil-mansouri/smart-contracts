...
interface SocialCampaignContractProxyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "listCampaignByStatus(uint256,uint256,uint8)": FunctionFragment;
    ...
    "pauseCampaign(uint256,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "listCampaignByStatus",
...
export class SocialCampaignContractProxy extends Contract {
  ...
  interface: SocialCampaignContractProxyInterface;
  ...
  functions: {
    ...
    "listCampaignByStatus(uint256,uint256,uint8)"(
      start: BigNumberish,
      limit: BigNumberish,
      cycle: BigNumberish,
      overrides?: CallOverrides
