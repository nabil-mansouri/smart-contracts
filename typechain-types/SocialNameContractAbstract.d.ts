...
interface SocialNameContractAbstractInterface extends ethers.utils.Interface {
  functions: {
...
export class SocialNameContractAbstract extends Contract {
  ...
  interface: SocialNameContractAbstractInterface;
