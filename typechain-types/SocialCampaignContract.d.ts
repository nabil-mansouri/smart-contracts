...
interface SocialCampaignContractInterface extends ethers.utils.Interface {
  functions: {
...
export class SocialCampaignContract extends Contract {
  ...
  interface: SocialCampaignContractInterface;
  ...
  functions: {
    ...
    "createCampaign((uint256,uint256,bytes,uint256[],uint256,address,uint256,uint256,uint256,uint256,address,(uint256,uint256,uint256),bytes,bytes32,uint8))"(
      campaign: {
        id: BigNumberish;
        network: BigNumberish;
        uri: BytesLike;
    ...
    "doCreateCampaignPublic((uint256,uint256,bytes,uint256[],uint256,address,uint256,uint256,uint256,uint256,address,(uint256,uint256,uint256),bytes,bytes32,uint8),address,uint256,bool)"(
      campaign: {
        id: BigNumberish;
        network: BigNumberish;
        uri: BytesLike;
