...
interface SocialViewInterface extends ethers.utils.Interface {
  functions: {
...
export class SocialView extends Contract {
  ...
  functions: {
    ...
    "generateUserDataCampaign((uint256,uint256,bytes,uint256[],uint256,address,uint256,uint256,uint256,uint256,address,(uint256,uint256,uint256),bytes,bytes32,bool))"(
      cam: {
        id: BigNumberish;
        network: BigNumberish;
        uri: BytesLike;
